...
export const heroMetrics = [
  ...
  { value: "4 контура", label: "Telegram / AI / Backend / Data" },
];
...
export const specializations = [
  ...
  {
    title: "Backend, данные и интеграции",
  ...
  {
    title: "Web-инструменты, парсеры и crypto-автоматизация",
    ...
    includes: [
      ...
      "биржевые API, мониторинг, сигналы и risk-limits",
    ],
...
export const proofItems = [
  {
    title: "Платежи",
    summary: "YooKassa, CryptoBot, Telegram Stars, статусы, webhook-и и подписки.",
...
export const processSteps = [
  ...
  {
    title: "Architecture",
    text: "Собираю схему, интеграции, состояния, критерии приёмки и границы MVP.",
  },
  {
    title: "Build",
    text: "Разрабатываю backend, бота, Mini App, frontend, AI, parser или payment-модули.",
  },
  {
    title: "Launch",
    text: "Готовлю Docker, env, логи, webhooks, smoke checks и production-запуск.",
  },
  {
    title: "Support",
    text: "После релиза закрываем баги, стабилизируем сценарии и планируем итерации.",
  },
];
...
export const ui = {
  ...
  specialization: {
    ...
    title:
      "Четыре production-контура вместо ленты одинаковых услуг",
    description:
  ...
  trust: {
    ...
    title:
      "Production-модули, которые держу под контролем",
    description:
      "Платежи, админки, AI, парсеры, деплой и поддержка остаются внутри одного рабочего сценария, а не отдельной полосой proof.",
    proofLabel: "proof",
  },
  configurator: {
  ...
  process: {
    ...
    title: "Как проект проходит от scope до запуска",
    description:
      "Один раздел показывает и ход работы, и production-контур: что фиксируем до кода, что собираем, как запускаем и что остаётся под контролем.",
    metrics: [
      { label: "Scope", value: "сценарии и границы" },
      { label: "Build", value: "модули и интеграции" },
      { label: "Launch", value: "деплой и smoke checks" },
    ],
  },
  cases: {
    eyebrow: "Кейсы",
    ...
    description:
      "На главной — один крупный проект и короткая подборка разных типов работ: Telegram, AI, crypto, backend, Mini App и web. Подробности, схемы и технические решения вынесены на отдельную страницу.",
    intro:
    ...
    nextStepTitle: "Превратите похожий кейс в первый scope",
    estimateCta: "Собрать мой scope",
