...
export const ui = {
  ...
  estimator: {
    ...
    kicker: "Точный расчет",
    title: "Тип проекта -> оценка -> контакт",
    leadTitle: "Можно посчитать точнее или просто написать",
    leadDescription:
      "Выберите тип проекта, если хотите вилку бюджета. Если вводных мало, оставьте короткую заявку выше или напишите напрямую.",
    leadBullets: ["ориентир бюджета сразу", "контакт и задача", "модули необязательны"],
    summaryCta: "Отправить расчет",
    modulesToggle: "Уточнить модули, если нужно",
    ...
    modulesTitle: "Модули (необязательно)",
    modulesDescription: "Показаны опции для категории «{category}». Их можно не раскрывать, если нужен только быстрый ориентир.",
    urgencyTitle: "Сроки",
    urgencyDescription:
      "Выберите комфортный темп. Срочность повышает стоимость, но сжимает план работ.",
    contactsTitle: "Контакты и описание",
    contactsDescription:
      "Оставьте любой удобный контакт и пару строк о задаче. Остальные детали можно уточнить в переписке.",
    fields: {
      name: "Имя",
      namePlaceholder: "Как к вам обращаться",
      contact: "Куда написать",
      contactPlaceholder: "@username, +7..., email или WhatsApp",
      email: "Email",
    ...
    directFallback: "Оставить короткую заявку",
    validationError: "Оставьте контакт и коротко опишите задачу.",
    fallbackSubmitError: "Не удалось отправить заявку.",
    unknownSubmitError:
      "Не удалось отправить заявку. Попробуйте оставить короткую заявку или написать напрямую.",
    successDelivered:
      "Заявка отправлена. Я вернусь с уточнениями.",
    successStub:
      "Заявка принята. Напишу по указанному контакту в ближайшее время.",
