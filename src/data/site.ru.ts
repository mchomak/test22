...
export const processSteps = [
  ...
  {
    title: "Схема решения",
    text: "Собираю схему решения: интеграции, состояния, критерии приёмки и границы первой версии.",
  },
  {
    title: "Разработка",
    text: "Разрабатываю серверную часть, бота, Mini App, интерфейс, AI-модуль, парсер или платежную часть.",
  },
  {
    title: "Запуск",
    text: "Готовлю Docker, переменные окружения, логи, события от сервисов и быстрые проверки после запуска.",
  },
  {
    title: "Поддержка",
...
export const ui = {
  ...
  hero: {
    ...
    bottomNote: "Схема / разработка / запуск / поддержка",
  },
  liveTelemetry: {
  ...
  process: {
    ...
    description:
      "Один блок показывает ход работы и рабочий контур: что фиксируем до кода, что собираем, как запускаем и что остаётся под контролем.",
    metrics: [
      { label: "Задача", value: "сценарии и границы" },
      { label: "Разработка", value: "модули и интеграции" },
      { label: "Запуск", value: "деплой и быстрые проверки" },
    ],
  },
  cases: {
    eyebrow: "Кейсы",
