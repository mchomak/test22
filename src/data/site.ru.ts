...
export const heroMetrics = [
  ...
  { value: "6 направлений", label: "Telegram / ИИ / сервисы / сайты / сбор данных / крипта" },
];
...
export const specializations = [
  {
    ...
    audience: "Бизнесу, которому нужно принимать заявки, продавать, вести подписки, личные кабинеты и поддержку прямо в Telegram — там, где уже есть клиенты.",
    includes: [
      "боты для заявок, магазинов, подписок и оплат",
      "мини-приложения с каталогом, личным кабинетом и приглашением друзей",
      "панель управления, уведомления, отчёты и выгрузки",
    ],
    tech: "aiogram 3, Telegram Bot API, Telegram Web Apps, PostgreSQL, Redis",
    result: "Вы получаете не просто чат-бота, а готовую систему продаж внутри Telegram: клиент сам проходит путь до оплаты или нужного действия.",
  },
  {
    title: "Искусственный интеллект и нейросети",
    audience: "Командам, которые хотят встроить искусственный интеллект в продукт, поддержку, обучение, обработку документов или повседневные задачи.",
    includes: [
      "умные помощники и сценарии на базе ChatGPT и Claude",
      "ответы по вашим документам, их обработка и сортировка",
      "история переписки, права доступа, лимиты и контроль ответов",
    ],
    tech: "OpenAI SDK, Anthropic SDK, PyTorch, FastAPI, PostgreSQL",
    result: "Искусственный интеллект становится частью работы: отвечает по вашим данным, ускоряет рутину и убирает ручное копирование между сервисами.",
  },
  {
    title: "Сбор данных и автоматизация",
    audience: "Проектам, где нужно регулярно собирать данные, следить за изменениями, обновлять таблицы, присылать оповещения и убирать ручную работу.",
    includes: [
      "сбор данных с одного или нескольких сайтов",
      "запуск по расписанию и стабильная работа даже при блокировках",
      "выгрузка в Excel, Google Таблицы или базу данных",
    ],
    tech: "Python asyncio, Playwright, requests/httpx, PostgreSQL, cron/workers",
    result: "Данные приходят по расписанию и в нужном виде, а команда не тратит часы на копирование, сверку и ручные уведомления.",
  },
  {
    title: "Сайты, сервисы и панели управления",
    audience: "Командам, которым нужен рабочий сайт или сервис: личный кабинет, панель со сводками, форма заявок или внутренний инструмент.",
    includes: [
      "видимая часть сайта, серверная логика и права пользователей",
      "формы, таблицы, статусы, сводки и аналитика",
      "оплаты, подключения к другим сервисам, уведомления и запуск",
    ],
    tech: "Next.js, React, FastAPI, PostgreSQL, Docker, Nginx",
    result: "Получается понятный рабочий инструмент для клиентов, менеджеров или операторов, а не набор разрозненных программ.",
  },
  {
    title: "Крипто-проекты и торговые боты",
    audience: "Крипто-проектам, обменникам и трейдинговым командам, которым нужны подключение к биржам, отслеживание цен, сигналы, платежи или данные из блокчейна.",
    includes: [
      "подключение к биржам (Bybit, Binance, OKX) и крипто-оплаты",
      "отслеживание цен, торговые сигналы и оповещения в Telegram",
      "запись сделок, ограничения по риску и безопасный тестовый режим",
    ],
    tech: "Bybit API, Binance API, Solana / Ethereum, PostgreSQL, Telegram Bot API",
    result: "Автоматика следит за рынком, фиксирует события и помогает реагировать быстрее, без постоянного ручного наблюдения.",
  },
  {
    title: "Серверная часть и базы данных",
    audience: "Продуктам, которым нужна надёжная серверная основа: хранение данных, статусы, очереди задач, подключения к другим сервисам и стабильный запуск.",
    includes: [
      "серверные сервисы, базы данных и фоновые задачи",
      "вход по паролю, права доступа и связь с внешними сервисами",
      "журналы работы, запуск через Docker и понятная структура проекта",
    ],
    tech: "FastAPI, SQLAlchemy 2.0 async, PostgreSQL, Redis, Docker",
    result: "Серверная часть выдерживает реальную нагрузку: хранит данные, обрабатывает ошибки и остаётся понятной для развития.",
  },
];
...
export const projectTypes: Array<{
...
}> = [
  {
    id: "telegram-bot",
    label: "Telegram-бот",
    description: "Заявки, оплаты, подписки, уведомления, личные кабинеты и работа операторов.",
    baseLow: 35000,
    baseHigh: 65000,
    daysLow: 7,
    daysHigh: 12,
  ...
  },
  {
    ...
    label: "Мини-приложение в Telegram",
    description: "Приложение внутри Telegram: каталог, личный кабинет, корзина, оплата, приглашение друзей и панель управления.",
    baseLow: 70000,
    baseHigh: 115000,
    daysLow: 12,
    daysHigh: 20,
  ...
  },
  {
    ...
    description: "Умный помощник, ответы по вашим документам, обработка файлов, создание текстов или ИИ внутри продукта.",
    baseLow: 60000,
    baseHigh: 105000,
    daysLow: 10,
    daysHigh: 18,
  ...
  },
  {
    ...
    label: "Сбор данных / автоматизация",
    description: "Сбор данных, задачи по расписанию, выгрузки, уведомления и связь с таблицами или базой данных.",
    baseLow: 30000,
    baseHigh: 60000,
    daysLow: 5,
    daysHigh: 12,
  ...
  {
    id: "web-service",
    label: "Сайт / панель управления",
    description: "Сайт или сервис, серверная логика, права доступа, сводки, панель управления, оплаты и связь с другими сервисами.",
    baseLow: 75000,
    baseHigh: 130000,
    daysLow: 14,
    daysHigh: 24,
  ...
  },
  {
    ...
    label: "Крипто / торговый бот",
    description: "Подключение к биржам, отслеживание цен, сигналы, оповещения в Telegram, крипто-оплаты и ограничения по риску.",
    baseLow: 65000,
    baseHigh: 120000,
    daysLow: 10,
    daysHigh: 20,
  ...
  },
  {
    ...
    description: "Подходит, если есть идея или задача, но пока нет точного понимания, как её лучше решить.",
    baseLow: 20000,
    baseHigh: 45000,
    daysLow: 4,
    daysHigh: 9,
...
export const ui = {
  ...
  hero: {
    ...
    description:
      "Делаю под ключ ботов, мини-приложения, серверную часть, нейросети, панели управления и оплаты — от идеи до запуска на сервере.",
  ...
  specialization: {
    ...
    title:
      "Понятный набор решений: Telegram, нейросети, серверная часть, сайты, сбор данных и крипта",
    description:
      "Каждое направление выстроено вокруг результата для бизнеса: заявки, платежи, данные, автоматизация, интерфейсы, подключения и запуск.",
    taskLabel: "task",
  ...
  configurator: {
    eyebrow: "Точный расчёт",
    title: "Если хотите точнее — соберите параметры проекта",
    description:
      "Это не обязательный шаг. Можно выбрать тип решения и получить ориентир по бюджету, а детали раскрыть только при необходимости.",
  },
  quickLead: {
