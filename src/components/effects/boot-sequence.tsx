      ...
      {!done ? (
        ...
        >
          ...
          <motion.div
            ...
            transition={{ duration: 0.46, delay: 0.35, ease: [0.22, 1, 0.36, 1] }}
          >
              ...
              <div className="grid gap-2 p-4 font-mono text-xs leading-6 text-zinc-400 sm:text-sm">
                {copy.logs.map((line, index) => (
                  <motion.div
                    ...
                    transition={{ delay: 0.62 + index * 0.2, duration: 0.21 }}
                  >
                    ...
                    <motion.span
                      ...
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
                      transition={{ delay: 0.73 + index * 0.2 }}
                    />
                  </motion.div>
                ))}
              </div>
            ...
            <div className="mt-5 h-1.5 overflow-hidden rounded-full bg-white/10">
              <motion.div
                ...
                initial={{ width: "0%" }}
                animate={{ width: "100%" }}
                transition={{ duration: 1.65, delay: 0.55, ease: [0.22, 1, 0.36, 1] }}
              />
            </div>
          </motion.div>
        </motion.div>
